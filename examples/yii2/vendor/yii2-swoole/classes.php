...
return [
    ...
    'yiiswoole\web\Controller'                     => VENDOR_PATH . '/yii2-swoole/web/Controller.php',
    'yiiswoole\web\ErrorHandler'                   => VENDOR_PATH . '/yii2-swoole/web/ErrorHandler.php',
    'yiiswoole\web\Request'                        => VENDOR_PATH . '/yii2-swoole/web/Request.php',
    'yiiswoole\web\Response'                       => VENDOR_PATH . '/yii2-swoole/web/Response.php',
    'yiiswoole\web\Session'                        => VENDOR_PATH . '/yii2-swoole/web/Session.php',
    'yiiswoole\web\User'                           => VENDOR_PATH . '/yii2-swoole/web/User.php',
    'yiiswoole\db\Command'                         => VENDOR_PATH . '/yii2-swoole/db/Command.php',
    'yiiswoole\db\Connection'                      => VENDOR_PATH . '/yii2-swoole/db/Connection.php',
    'yiiswoole\redis\Connection'                   => VENDOR_PATH . '/yii2-swoole/redis/Connection.php',
    'yiiswoole\redis\Session'                      => VENDOR_PATH . '/yii2-swoole/redis/Session.php',
    'yiilog\EmailTarget'                           => VENDOR_PATH . '/yii2-log/EmailTarget.php',
    'yiilog\RedisTarget'                           => VENDOR_PATH . '/yii2-log/RedisTarget.php',
    'yiilog\LogstashFileTarget'                    => VENDOR_PATH . '/yii2-log/LogstashFileTarget.php',
