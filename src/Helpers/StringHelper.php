...
class StringHelper
{
     ...
     */
    public static function truncate($string, $length, $suffix = '...', $encoding)
    {
     ...
     */
    public static function startsWith($string, $with, $encoding, $caseSensitive = true)
    {
     ...
     */
    public static function endsWith($string, $with, $encoding, $caseSensitive = true)
    {
        if (!$bytes = static::byteLength($with)) {
            return true;
        }
