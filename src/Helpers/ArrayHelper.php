...
class ArrayHelper
{
    ...
    /**
     * 把一个List数组，转换成某列的HashMap
     * 也可以用array_combine(array_column($array, 'pid'), $array)实现，foreach效率高一倍
     * @param array $array
     * @param $key
     * @return array
     */
    public static function arrayColumnAssoc(array &$array, $key): array
    {
